...
type DefaultValueAssertions = [
  ...
  Expect<
    HasAllProperties<
      ImageFieldMetadata,
      {
        defaultValue: JsonbProperty<FieldMetadataDefaultValueMapping[FieldMetadataType.IMAGE]>;
      }
    >
  >,
  Expect<
    HasAllProperties<
      PdfFieldMetadata,
      {
        defaultValue: JsonbProperty<FieldMetadataDefaultValueMapping[FieldMetadataType.PDF]>;
      }
    >
  >,
